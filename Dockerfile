...
# Adicionando comando para construir e executar a aplicação
FROM build AS inspect_builder
RUN echo "Building inspect image"

FROM run AS inspect_runner
RUN echo "Running inspect image"
