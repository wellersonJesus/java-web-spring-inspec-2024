...
@Entity
@Table(name = "tanque_metalico")
public class TanqueMetalico {
	...
	private String protecao_contra_corrosao;
	...
	public String getDados_localizacao_identificacao() {
		return dados_localizacao_identificacao;
	}
	...
	public String getProtecao_contra_corrosao() {
		return protecao_contra_corrosao;
	}

	public void setProtecao_contra_corrosao(String protecao_contra_corrosao) {
		this.protecao_contra_corrosao = protecao_contra_corrosao;
	}
